...
class LidarFrameIDConverterNode : public rclcpp::Node
{
    private:
    ...
    public:
        LidarFrameIDConverterNode(): Node("lidar_frame_id_converter")
        {
...
void LidarFrameIDConverterNode::subscriber_callback(const PointCloud2::SharedPtr msg)
{
    auto new_msg = *msg;
...
int main(int argc, char * argv[])
{
    ...
    auto node = std::make_shared<LidarFrameIDConverterNode>();
    rclcpp::spin(node);
    rclcpp::shutdown();
    return 0;
}
